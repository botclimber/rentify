...
export class default1676027274920 implements MigrationInterface {
    name = 'default1676027274920'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`reviews\` (\`id\` int NOT NULL AUTO_INCREMENT, \`userId\` int NOT NULL, \`adminId\` int NOT NULL, \`review\` text NOT NULL, \`rating\` int NOT NULL, \`createdOn\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`approvedOn\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`anonymous\` tinyint NOT NULL, \`approved\` int NOT NULL, \`residenceAddressesId\` int NULL, UNIQUE INDEX \`REL_6e1b95f8483c03df7f0980e8cb\` (\`residenceAddressesId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
